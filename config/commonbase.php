...
return [
    ...
    'vfd' => [
        ...
        'consumer_key'          => env('VFD_CONSUMER_KEY', ''),
        'consumer_secret'       => env('VFD_CONSUMER_SECRET', ''),
        ...
        'vfd_webhook_user'      => env('VFD_WEBHOOK_USER', ''),
        'vfd_webhook_password'  => env('VFD_WEBHOOK_PASSWORD', ''),
    ]
];
